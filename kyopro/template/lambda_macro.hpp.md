...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"kyopro/template/lambda_macro.hpp\"\n#include <iterator>\r\
    \n#include <tuple>\r\n#line 2 \"kyopro/meta/tuple_like.hpp\"\n#include <cstddef>\r\
    \n#include <type_traits>\r\n#line 5 \"kyopro/meta/tuple_like.hpp\"\n#include <utility>\r\
    ...
    \ 5 \"kyopro/template/lambda_macro.hpp\"\n\r\n#define $(...) \\\r\n([&](auto&&...\
...
layout: document
redirect_from:
- /library/kyopro/template/lambda_macro.hpp
- /library/kyopro/template/lambda_macro.hpp.html
