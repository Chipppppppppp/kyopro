...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"kyopro/template/constant.hpp\"\n#include <array>\r\n#line\
    \ 2 \"kyopro/meta/setting.hpp\"\n#include <cstdint>\r\n\r\n#ifndef KYOPRO_BASE_INT\r\
    ...
    \ 1}, {0, 1}, {-1, 1}}};\r\n} // namespace kpr\r\n"
  code: "#pragma once\r\n#include <array>\r\n#include \"kyopro/meta/setting.hpp\"\r\
    \n\r\nnamespace kpr {\r\n    inline constexpr std::array<std::pair<KYOPRO_BASE_INT,\
  ...
  verifiedWith: []
documentation_of: kyopro/template/constant.hpp
layout: document
redirect_from:
- /library/kyopro/template/constant.hpp
- /library/kyopro/template/constant.hpp.html
