...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"kpr/algorithm/contains.hpp\"\n#include <algorithm>\n#include\
    \ <iterator>\n#line 2 \"kpr/meta/tuple_like.hpp\"\n#include <cstddef>\n#include\
    \ <type_traits>\n#include <tuple>\n#include <utility>\n\nnamespace kpr {\n   \
  ...
  verifiedWith: []
documentation_of: kpr/algorithm/contains.hpp
layout: document
redirect_from:
- /library/kpr/algorithm/contains.hpp
- /library/kpr/algorithm/contains.hpp.html
