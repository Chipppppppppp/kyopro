...
data:
  ...
  bundledCode: "#line 2 \"kpr/algorithm/bit.hpp\"\n#include <limits>\r\n#include <type_traits>\r\
    ...
    \ ()(T a, KYOPRO_BASE_UINT n, T init = Mul<T>::id()) const noexcept {\r\n    \
    \        while (n > 0) {\r\n                if (n & 1) init *= a;\r\n        \
    \        a *= a;\r\n                n >>= 1;\r\n            }\r\n            return\
    ...
    \   using value_type = uint_least_t<bit_len(mod * 2 - 2)>;\r\n        using multiplies_type\
    \ = uint_least_t<bit_len(mod) * 2>;\r\n\r\n        static constexpr value_type\
    \ m = mod;\r\n        value_type value;\r\n\r\n        static constexpr KYOPRO_BASE_INT\
    \ get_mod() noexcept {\r\n            return m;\r\n        }\r\n\r\n        constexpr\
    \ ModInt() noexcept = default;\r\n        template<class T>\r\n        constexpr\
    \ ModInt(T value) noexcept: value(floor_mod(value, m)) {}\r\n\r\n        template<class\
    \ T>\r\n        explicit constexpr operator T() const noexcept {\r\n         \
    \   return value;\r\n        }\r\n\r\n        static constexpr ModInt raw(value_type\
    \ value) noexcept {\r\n            ModInt res;\r\n            res.value = value;\r\
    \n            return res;\r\n        }\r\n\r\n        constexpr ModInt pow(KYOPRO_BASE_UINT\
    \ n) const noexcept {\r\n            value_type res = 1, a = value;\r\n      \
    \      while (n > 0) {\r\n                if (n & 1) res = static_cast<multiplies_type>(res)\
    \ * a % m;\r\n                a = static_cast<multiplies_type>(a) * a % m;\r\n\
    \                n >>= 1;\r\n            }\r\n            return res;\r\n    \
    \    }\r\n\r\n        constexpr ModInt inv() const noexcept {\r\n            value_type\
    \ a = value, b = m;\r\n            std::make_signed_t<value_type> u = 1, v = 0;\r\
    \n            while (b > 0) {\r\n                value_type t = a / b;\r\n   \
    \             a -= t * b;\r\n                std::swap(a, b);\r\n            \
    \    u -= t * v;\r\n                std::swap(u, v);\r\n            }\r\n    \
    ...
    \  }\r\n            }\r\n            if (n != 1) res -= res / n;\r\n         \
    \   return res;\r\n        }\r\n    } euler_phi;\r\n} // namespace kpr\r\n#line\
    \ 5 \"kpr/math/factorize.hpp\"\n#include <numeric>\r\n#include <random>\r\n#line\
    \ 9 \"kpr/math/is_prime.hpp\"\n\r\nnamespace kpr {\r\n    [[maybe_unused]] inline\
    ...
    \ kpr {\r\n    // Binary Indexed Tree\r\n    template<class T, class Op = Add<T>>\r\
    \n    struct FenwickTree {\r\n        using value_type = T;\r\n        using size_type\
    \ = std::size_t;\r\n        using reference = T&;\r\n        using const_reference\
    \ = const T&;\r\n        using operator_type = Op;\r\n\r\n    private:\r\n   \
    \     Op op;\r\n        std::vector<T> tree;\r\n\r\n    public:\r\n        FenwickTree()\
    \ noexcept = default;\r\n        explicit FenwickTree(std::size_t n) noexcept:\
    ...
    \ 3 \"kpr/template/stl.hpp\"\n#include <cctype>\r\n#include <cerrno>\r\n#include\
    \ <cfloat>\r\n#include <ciso646>\r\n#include <climits>\r\n#include <clocale>\r\
    \n#line 10 \"kpr/template/stl.hpp\"\n#include <csetjmp>\r\n#include <csignal>\r\
    \n#include <cstdarg>\r\n#line 15 \"kpr/template/stl.hpp\"\n#include <cstdlib>\r\
    \n#include <cstring>\r\n#include <ctime>\r\n\r\n#include <ccomplex>\r\n#include\
    \ <cfenv>\r\n#include <cinttypes>\r\n#include <cstdbool>\r\n#line 24 \"kpr/template/stl.hpp\"\
    \n#include <ctgmath>\r\n#include <cwchar>\r\n#include <cwctype>\r\n\r\n#line 30\
    \ \"kpr/template/stl.hpp\"\n#include <complex>\r\n#include <deque>\r\n#include\
    \ <exception>\r\n#include <fstream>\r\n#line 35 \"kpr/template/stl.hpp\"\n#include\
    \ <iomanip>\r\n#include <ios>\r\n#include <iosfwd>\r\n#include <iostream>\r\n\
    #include <istream>\r\n#line 42 \"kpr/template/stl.hpp\"\n#include <list>\r\n#include\
    \ <locale>\r\n#include <map>\r\n#include <memory>\r\n#include <new>\r\n#line 48\
    \ \"kpr/template/stl.hpp\"\n#include <ostream>\r\n#include <queue>\r\n#include\
    \ <set>\r\n#include <sstream>\r\n#include <stack>\r\n#include <stdexcept>\r\n\
    #include <streambuf>\r\n#line 56 \"kpr/template/stl.hpp\"\n#include <typeinfo>\r\
    \n#line 58 \"kpr/template/stl.hpp\"\n#include <valarray>\r\n#line 60 \"kpr/template/stl.hpp\"\
    \n\r\n#line 62 \"kpr/template/stl.hpp\"\n#include <atomic>\r\n#include <chrono>\r\
    \n#include <condition_variable>\r\n#include <forward_list>\r\n#include <future>\r\
    \n#include <initializer_list>\r\n#include <mutex>\r\n#line 70 \"kpr/template/stl.hpp\"\
    \n#include <ratio>\r\n#include <regex>\r\n#include <scoped_allocator>\r\n#include\
    \ <system_error>\r\n#include <thread>\r\n#line 76 \"kpr/template/stl.hpp\"\n#include\
    \ <typeindex>\r\n#line 79 \"kpr/template/stl.hpp\"\n#include <unordered_set>\r\
  ...
  path: kpr/all.hpp
  requiredBy: []
  timestamp: '2023-06-15 19:12:12+09:00'
