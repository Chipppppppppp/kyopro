...
data:
  ...
  bundledCode: "#line 2 \"data_structure/FenwickTree.hpp\"\n#include <cstddef>\r\n\
    ...
    \ noexcept: par(n, -1) {}\r\n\r\n        void resize(std::size_t x) { par.resize(x,\
    ...
    \ group_members;\r\n        }\r\n    };\r\n} // namespace kpr\r\n#line 4 \"data_structure/structure.hpp\"\
    \n"
  ...
  verifiedWith: []
documentation_of: data_structure/structure.hpp
layout: document
redirect_from:
- /library/data_structure/structure.hpp
- /library/data_structure/structure.hpp.html
