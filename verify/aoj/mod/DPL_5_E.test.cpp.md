...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/mod/DPL_5_E.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DPL_5_E\"\
    ...
    \ constexpr KYOPRO_BASE_FLOAT EPS = static_cast<T>(1) / power(10ULL, decimal_precision);\r\
    \n    // \u8A31\u5BB9\u3055\u308C\u308B\u5C0F\u6570\u8AA4\u5DEE\r\n    inline\
    \ constexpr KYOPRO_BASE_FLOAT eps = EPS<KYOPRO_BASE_FLOAT>;\r\n\r\n    // \u5186\
    \u5468\u7387\r\n    template<class T>\r\n    inline constexpr T PI = 3.14159265358979323846;\r\
    ...
    \ {\r\n        template<class Scanner>\r\n        static void scan(Scanner& scanner,\
    \ ModInt<mod>& a) {\r\n            std::int_fast64_t value;\r\n            ScanFunction<std::int_fast64_t>::scan(scanner,\
    ...
    \ n, KYOPRO_BASE_UINT r) noexcept {\n            return c(n + r - 1, r);\n   \
    \     }\n    };\n} // namespace kpr\n#line 4 \"verify/aoj/mod/DPL_5_E.test.cpp\"\
    \n\nint main() {\n    kpr::BinomMod<1000000, kpr::ModInt<1000000007>> bnm;\n \
    \   int n, k;\n    kpr::scan(n, k);\n    kpr::println(bnm.c(k, n));\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/aoj/mod/DPL_5_E.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/mod/DPL_5_E.test.cpp
- /verify/verify/aoj/mod/DPL_5_E.test.cpp.html
