...
namespace kyopro {
  ...
  public:
    ...
    constexpr ModInt operator -() const noexcept { return value == 0 ? 0 : mod - value; }
  ...
  struct Hash<ModInt<mod>> { constexpr std::size_t operator ()(ModInt<mod> a) const noexcept { return static_cast<std::size_t>(a); } };
}
