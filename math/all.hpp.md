...
data:
  ...
  bundledCode: "#line 2 \"math/div.hpp\"\n#include <type_traits>\n\nnamespace kyopro\
    ...
    \ 3 or _n == 5 or _n == 7) return true;\n    if (_n % 2 == 0 or _n % 3 == 0 or\
    \ _n % 5 == 0 or _n % 7 == 0) return false;\n    if (_n < 121) return _n > 1;\n\
    ...
    \      std::uint_fast64_t _t = _d;\n      while (_y != _one and _y != _minus_one\
    \ and _t != _n - 1) _y *= _y, _t <<= 1;\n      if (_y != _minus_one and !(_t &\
